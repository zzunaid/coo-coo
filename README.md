...
Prefer to skip straight to the file, or build it yourself? [Grab the DMG directly](https://github.com/zzunaid/coo-coo/releases/tag/v1.2.1) from Releases, or see [Building from source](#building-from-source) below.
